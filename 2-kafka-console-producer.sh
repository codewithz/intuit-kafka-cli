...
kafka-console-producer --bootstrap-server localhost:9092 --topic intuit_first_topic
...
kafka-console-producer --bootstrap-server localhost:9092 --topic intuit_first_topic --producer-property acks=all
...
kafka-console-producer --bootstrap-server localhost:9092 --topic intuit_fourth_topic
